...
class InceptionI3d_MX:
    def __init__(self, modality, num_classes=400, squeeze=True):
    ...
    def get_Mixed(self, data, filter_list=None, name='Mixed_3c'):
        ...
        branch_1 = self.BasicConv3d(data=branch_1, num_filter=filter_list[2], kernel=(3, 3, 3), stride=(1, 1, 1),
                                    pad=(1, 1, 1),
                                    name=('%s/%s/Branch_1/Conv3d_0b_3x3' % (self.modality, name)))
        ...
        branch_2 = self.BasicConv3d(data=branch_2, num_filter=filter_list[4], kernel=(3, 3, 3), stride=(1, 1, 1),
                                    pad=(1, 1, 1),
                                    name=('%s/%s/Branch_2/Conv3d_0b_3x3' % (self.modality, name)))

        # branch 3
        branch_3 = mx.sym.Pooling(data=data, kernel=(3, 3, 3), stride=(1, 1, 1), pad=(1, 1, 1), pool_type='max',
        ...
        branch_3 = self.BasicConv3d(data=branch_3, num_filter=filter_list[5], kernel=(1, 1, 1), stride=(1, 1, 1),
                                    name=('%s/%s/Branch_3/Conv3d_0b_1x1' % (self.modality, name)))
    ...
    def get_I3D(self):
        ...
        Conv3d_1a_7x7 = self.BasicConv3d(data=data, num_filter=64, kernel=(7, 7, 7), stride=(2, 2, 2), pad=(3, 3, 3),
                                         name=('%s/Conv3d_1a_7x7' % (self.modality)))

        MaxPool3d_2a_3x3 = mx.sym.Pooling(data=Conv3d_1a_7x7, kernel=(1, 3, 3), stride=(1, 2, 2), pad=(0, 1, 1),
                                          pool_type='max',
        ...
        MaxPool3d_3a_3x3 = mx.sym.Pooling(data=Conv3d_2c_3x3, kernel=(1, 3, 3), stride=(1, 2, 2), pad=(0, 1, 1),
                                          pool_type='max',
        ...
        MaxPool3d_4a_3x3 = mx.sym.Pooling(data=mixed_3c, kernel=(3, 3, 3), stride=(2, 2, 2), pad=(1, 1, 1),
                                          pool_type='max',
        ...
        MaxPool3d_5a_2x2 = mx.sym.Pooling(data=mixed_4f, kernel=(2, 2, 2), stride=(2, 2, 2), pad=(0, 0, 0),
                                          pool_type='max',
